...
function NavBar() {
  ...
  return (
    <>
      {/* navbr  */}
      <div className="sticky top-0 right-0 left-0 z-10 w-full h-16 flex flex-row justify-around items-center bg-cyan-700 x-sm:justify-between x-sm:px-2">
        <div className='w-9'>
            <Link to={'/'}>
        ...
        <div className="hidden x-sm:block">
